                ...
                <div class="row g-3">
                    <div class="col-xl-2 col-lg-3 d-flex align-items-stretch" style="margin-left: auto; margin-right: auto;">
                        ...
                        <div class="card text-center bg-light">
                            ...
                            <div class="card-footer">
                                <form class="d-block">
                                    <a class="btn btn-primary" href="userAdminAreaProd.php">
                    ...
                    <div class="col-xl-2 col-lg-3 d-flex align-items-stretch" style="margin-left: auto; margin-right: auto;">
                        <div class="card text-center bg-light">
                            ...
                            <div class="card-footer">
                                <form class="d-block">
                                    <a class="btn btn-primary" href="userAdminAreaUsers.php">
                                        <h5 style="color: black;">Acessar</h5>
                                    </a>
                                </form>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-3 d-flex align-items-stretch" style="margin-left: auto; margin-right: auto;">
                        <div class="card text-center bg-light">
                            ...
                            <div class="card-footer">
                                <form class="d-block">
                                    <a class="btn btn-primary" href="userAdminAreaAdm.php">
                                        <h5 style="color: black;">Acessar</h5>
                                    </a>
                                </form>
                            </div>
