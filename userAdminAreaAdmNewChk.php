...
exit;}?>
    ...
    include "connect.php";
    $data = $_POST;
    $qry = 'INSERT INTO `usuarios_adm` (`Codigo`, `Nome`, `Login`, `Senha`) VALUES (NULL, "' . $data['nome'] . '", "' . $data['user'] . '", md5("' . $data['passwd'] . '"));';
    $pdo->exec($qry);
    echo 'Registro Gravado';
    ?>
    <a class="btn btn-lg btn-success" href="userAdminAreaAdmNew.php">Cadastrar Novo</a>
    <a class="btn btn-lg btn-primary" href="userAdminAreaAdm.php">Voltar</a>
            </div>
        </main>
