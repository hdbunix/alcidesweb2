...
exit;}?>
        <main class="flex-fill">
            <div class="container">
                <?php
                include "connect.php";
                $lista_adm = $pdo->query('SELECT Codigo, Nome, Login from usuarios_adm');
                ...
                ?> <tr><th>Codigo </th><th>Nome </th><th>Login </th><th></th><th></th></tr> <?php
                    ...
                    echo '<tr>';
                    echo '<td>' . $row['Codigo'] . '</td><td>' . $row['Nome'] . '</td><td>' . $row['Login'] . '</td><td><a href="userAdminAreaAdmDel.php?cod=' . $row['Codigo'] . '">Excluir</a></td>';
                    echo '<td><a href="userAdminAreaAdmUp.php?cod=' . $row['Codigo'] . '">Atualizar</a></td>';
                    echo '</tr>';
                }
                echo '</table>'
                ?>
                <br>
                <a class="btn btn-lg btn-success" href="userAdminAreaAdmNew.php">Gravar Novo</a>
