...
exit;}?>
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                include "connect.php";
                $data = $_GET;
                $alt_useradm = $pdo->query('SELECT Codigo, Nome, Login, Senha FROM usuarios_adm WHERE Codigo=' . $data['cod'])->fetch();
                ...
                <hr>
                <form name="Geral" action="userAdminAreaAdmUpChg.php" method="POST">
